 ...
 * @author Karl
 *         <p>
 *         Represents the local bone-space transform of a joint at a certain
 *         keyframe during an animation. This includes the position and rotation
 *         of the joint, relative to the parent joint (or relative to the
 *         model's origin if it's the root joint). The transform is stored as a
 *         position vector and a quaternion (rotation) so that these values can
 *         be easily interpolated, a functionality that this class also
 *         provides.
 */
...
public class JointTransform {
	 ...
	 * @param rotation - the rotation of the joint relative to te parent joint
	 * (local-space) at a certain keyframe.
	 */
	...
	/**
	 * @param localTransform - the joint's local-transform at a certain keyframe of an
	 * animation.
	 */
