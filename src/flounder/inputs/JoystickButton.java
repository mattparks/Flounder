...
public class JoystickButton extends BaseButton {
	...
	public JoystickButton(int joystick, int... joystickButtons) {
		super((int code) -> (FlounderDevices.getJoysticks() != null && FlounderDevices.getJoysticks().isConnected(joystick) ? FlounderDevices.getJoysticks().getButton(joystick, code) : false), joystickButtons);
	}
}
