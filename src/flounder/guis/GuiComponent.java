...
public abstract class GuiComponent {
	...
	/**
	 * Increases the relative position of the component.
	 *
	 * @param dX The direction in the X component.
	 * @param dY The direction in the Y component.
	 */
